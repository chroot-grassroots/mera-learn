...
async function updateJourneyButtons(): Promise<void> {
    const unauthenticatedButtons = document.querySelector("#unauthenticated-buttons") as HTMLElement;
    const authenticatedButtons = document.querySelector("#authenticated-buttons") as HTMLElement;
